...
> For more information, refer to [**Starting with Blender 2.79**](Guides/Armor/3Darmor_page1).
...
>
> On **Forge**, you need to use `@Mod.EventBusSubscriber` instead of `@EventBusSubscriber` and explicitly specify the bus — in this case, it must be the **MOD bus**.
