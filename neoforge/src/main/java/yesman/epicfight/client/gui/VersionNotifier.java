...
public class VersionNotifier {
    ...
    public VersionNotifier(Minecraft minecraft) {
        ...
        this.visible = ModList.get().getModFileById(EpicFight.MODID).versionString().matches("[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+");
    }
    ...
    public void render(GuiGraphics guiGraphics, boolean inWorld) {
        ...
        if (inWorld) {
            ...
            String l2 = Component.translatable(LangKeys.GUI_MESSAGE_VERSION_NOTIFIER_TEST_VERSION_WARNING_LINE2, ModList.get().getModFileById(EpicFight.MODID).versionString()).getString();
            ...
            String l1 = Component.translatable(LangKeys.GUI_MESSAGE_VERSION_NOTIFIER, ModList.get().getModFileById(EpicFight.MODID).versionString()).getString();
            guiGraphics.drawString(this.minecraft.font, l1, (width - this.minecraft.font.width(l1) - 2), 8, 16777215);
        }
    }
}
