...
public class ColliderPreset implements PreparableReloadListener {
	...
	public static final Collider GREATSWORD = registerCollider(EpicFight.identifier("greatsword"), new MultiOBBCollider(3, 0.5D, 0.8D, 1.0D, 0D, 0D, -1.0D));
	...
	public static final Collider TACHI = registerCollider(EpicFight.identifier("tachi"), new MultiOBBCollider(3, 0.4D, 0.4D, 0.95D, 0D, 0D, -0.95D));
	...
	public static final Collider LONGSWORD = registerCollider(EpicFight.identifier("longsword"), new MultiOBBCollider(3, 0.4D, 0.4D, 0.8D, 0D, 0D, -0.75D));
