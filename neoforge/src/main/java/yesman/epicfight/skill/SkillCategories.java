...
public enum SkillCategories implements SkillCategory {
	...
	DODGE(true, true, true, SKILL_CATEGORY_DODGE, EpicFightNeoForge.identifier("skillbook_dodge")),
	PASSIVE(true, true, true, SKILL_CATEGORY_PASSIVE, EpicFightNeoForge.identifier("skillbook_passive")),
	...
	GUARD(true, true, true, SKILL_CATEGORY_GUARD, EpicFightNeoForge.identifier("skillbook_guard")),
	KNOCKDOWN_WAKEUP(false, false, false, SKILL_CATEGORY_KNOCKDOWN_WAKEUP),
	MOVER(true, true, true, SKILL_CATEGORY_MOVER, EpicFightNeoForge.identifier("skillbook_mover")),
	IDENTITY(true, true, true, SKILL_CATEGORY_IDENTITY, EpicFightNeoForge.identifier("skillbook_identity")),
