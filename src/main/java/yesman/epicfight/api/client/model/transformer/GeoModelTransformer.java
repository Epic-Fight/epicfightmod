...
import yesman.epicfight.mixin.geckolib.GeckolibMixinGeoArmorRenderer;
...
public class GeoModelTransformer extends HumanoidModelTransformer {
	...
	public SkinnedMesh transformArmorModel(HumanoidModel<?> humanoidModel) {
		...
		GeckolibMixinGeoArmorRenderer accessor = (GeckolibMixinGeoArmorRenderer)geoArmorRenderer;
