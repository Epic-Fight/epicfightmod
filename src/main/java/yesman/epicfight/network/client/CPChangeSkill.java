...
public record CPChangeSkill(SkillSlot skillSlot, @Nullable Holder<Skill> skill, int itemSlotIndex, boolean consumeXp) implements ManagedCustomPacketPayload {
	public static final StreamCodec<RegistryFriendlyByteBuf, CPChangeSkill> STREAM_CODEC =
		StreamCodec.composite(
			...
			CPChangeSkill::skill,
			ByteBufCodecs.INT,
			CPChangeSkill::itemSlotIndex,
			ByteBufCodecs.BOOL,
			CPChangeSkill::consumeXp,
			CPChangeSkill::new
	    );
}
